...
class DrivingClient(DrivingController):
    ...
    def control_driving(self, car_controls, sensing_info):
        ...
        self.target_point_level = int(self.full_road_width / 2)
    ...
    def make_decision(self, sensing_info, car_controls, curve_info) :
        ...
        # brake
        brake_value = (math.pow(1.2, abs(car_controls.steering) * sensing_info.speed) -3)/20 # Rule of Thumb 1.2, 3, 5
        ...
        throttle_value = 0
        if sensing_info.speed < 120 - min_info[2] :
            throttle_value = 1   
            if self.debug_level >= self.debug_controls_only:
    ...
    def calc_priority(self, calced_dist, calced_angle):
        ...
        return calced_dist * math.pow(1.5, abs(calced_angle)/20)
